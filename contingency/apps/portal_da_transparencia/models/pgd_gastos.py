# apps/portal_da_transparencia/models/pgd_gastos.py
"""
PGD — Gastos

Fonte    : Portal da Transparência — CGU
S3       : portal_da_transparencia/parquet/modulo=pgd-gastos/
Histórico: 2013 → 2026 (múltiplos arquivos/mês)

Informações detalhadas sobre gastos da Administração Pública Federal
com classificação por categoria, grupo e elemento de despesa.
...
class PGDGastos(DuckDBModel):
    """
    PGD — Gastos — camada Bronze.
    Espelho fiel do parquet no S3. Nenhuma transformação aplicada.

    Uso:
        PGDGastos.scan(ano="2022", mes="05").fetchdf()
    """
