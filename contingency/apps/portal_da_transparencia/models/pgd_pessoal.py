# apps/portal_da_transparencia/models/pgd_pessoal.py
"""
PGD — Pessoal

Fonte    : Portal da Transparência — CGU
S3       : portal_da_transparencia/parquet/modulo=pgd-pessoal/
Histórico: 2013 → 2026 (múltiplos arquivos/mês)

Informações sobre despesas com pessoal da Administração Pública Federal,
incluindo vencimentos, vantagens e benefícios.
...
class PGDPessoal(DuckDBModel):
    """
    PGD — Pessoal — camada Bronze.
    Espelho fiel do parquet no S3. Nenhuma transformação aplicada.

    Uso:
        PGDPessoal.scan(ano="2022", mes="05").fetchdf()
    """
