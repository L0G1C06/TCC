# apps/portal_da_transparencia/models/pgd.py
"""
Plano Geral de Despesas (PGD)

Fonte    : Portal da Transparência — CGU
S3       : portal_da_transparencia/parquet/modulo=pgd/
Histórico: 2013 → 2026 (múltiplos arquivos/mês)

Informações consolidadas sobre o Plano Geral de Despesas com detalhes
por categoria, grupo, elemento e subelemento de despesa.
...
class PGD(DuckDBModel):
    """
    Plano Geral de Despesas (PGD) — camada Bronze.
    Espelho fiel do parquet no S3. Nenhuma transformação aplicada.

    Uso:
        PGD.scan(ano="2022", mes="05").fetchdf()
    """
