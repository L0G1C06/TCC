# apps/portal_da_transparencia/models/despesas_indiretas.py
"""
Despesas Indiretas

Fonte    : Portal da Transparência — CGU
S3       : portal_da_transparencia/parquet/modulo=despesas-indiretas/
Histórico: 2013 → 2026 (múltiplos arquivos/mês)

Despesas que não são diretamente vinculadas a programas ou ações
orçamentárias, como despesas de manutenção de órgãos e entidades.
...
class DespesasIndiretas(DuckDBModel):
    """
    Despesas Indiretas — camada Bronze.
    Espelho fiel do parquet no S3. Nenhuma transformação aplicada.

    Uso:
        DespesasIndiretas.scan(ano="2022", mes="05").fetchdf()
    """

    dataset_path = "portal_da_transparencia/parquet/"
    modulo       = "despesas-indiretas"
