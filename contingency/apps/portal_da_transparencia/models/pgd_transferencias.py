# apps/portal_da_transparencia/models/pgd_transferencias.py
"""
PGD — Transferências

Fonte    : Portal da Transparência — CGU
S3       : portal_da_transparencia/parquet/modulo=pgd-transferencias/
Histórico: 2013 → 2026 (múltiplos arquivos/mês)

Informações sobre transferências realizadas pela Administração Pública
Federal para outros entes federativos ou entidades privadas.
...
class PGDTransferencias(DuckDBModel):
    """
    PGD — Transferências — camada Bronze.
    Espelho fiel do parquet no S3. Nenhuma transformação aplicada.

    Uso:
        PGDTransferencias.scan(ano="2022", mes="05").fetchdf()
    """

    dataset_path = "portal_da_transparencia/parquet/"
    modulo       = "pgd-transferencias"
