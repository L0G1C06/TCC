# apps/portal_da_transparencia/models/transferencias.py
"""
Transferências

Fonte    : Portal da Transparência — CGU
S3       : portal_da_transparencia/parquet/modulo=transferencias/
Histórico: 2013 → 2026 (múltiplos arquivos/mês)

Informações detalhadas sobre transferências financeiras realizadas pela
Administração Pública Federal para outros entes federativos ou entidades.
...
class Transferencias(DuckDBModel):
    """
    Transferências — camada Bronze.
    Espelho fiel do parquet no S3. Nenhuma transformação aplicada.

    Uso:
        Transferencias.scan(ano="2022", mes="05").fetchdf()
    """
