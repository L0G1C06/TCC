...
class CNEPRecord(models.Model):
    """
    Amostra de sancionados no CNEP extraídos do S3.
    """
    ...
    nome_informado_orgao = models.CharField(max_length=300, blank=True, null=True)
    ...
    # ── Valor ─────────────────────────────────────────────────────────
    valor_multa = models.CharField(max_length=50, blank=True, null=True)
