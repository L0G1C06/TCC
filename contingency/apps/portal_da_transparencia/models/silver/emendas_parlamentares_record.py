...
class EmendasParlamentaresRecord(models.Model):
    """
    Amostra de emendas parlamentares extraídas do S3.
    """
    ...
    nome_do_autor = models.CharField(max_length=300, blank=True, null=True)
    sigla_do_partido = models.CharField(max_length=20, blank=True, null=True)
    uf_do_autor = models.CharField(max_length=2, blank=True, null=True)

    # ── Valor ─────────────────────────────────────────────────────────
    valor_da_emenda = models.CharField(max_length=50, blank=True, null=True)
    ...
    # ── Localidade ────────────────────────────────────────────────────
    localidade_de_aplicacao = models.CharField(max_length=300, blank=True, null=True)
    codigo_municipio_siafi = models.CharField(max_length=10, blank=True, null=True)
    nome_municipio = models.CharField(max_length=300, blank=True, null=True)
    ...
    def __str__(self):
        return f"{self.nome_do_autor} - {self.numero_da_emenda} ({self.valor_da_emenda})"
