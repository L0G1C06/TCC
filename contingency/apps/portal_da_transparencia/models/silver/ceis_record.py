...
class CEISRecord(models.Model):
    """
    Amostra de 30 registros do CEIS extraídos do S3.
    """
    ...
    abrangencia_sancao = models.CharField(max_length=100, blank=True, null=True)

    # ── Sancionado ────────────────────────────────────────────────────
    tipo_de_pessoa = models.CharField(max_length=1, blank=True, null=True)
    ...
    nome_informado_pelo_orgao = models.CharField(max_length=300, blank=True, null=True)
    ...
    # ── Processo ──────────────────────────────────────────────────────
    numero_do_processo = models.CharField(max_length=100, blank=True, null=True)
