...
class DespesasRecord(models.Model):
    """
    Amostra de despesas consolidadas extraídas do S3.
    """
    ...
    # ── Natureza da Despesa ───────────────────────────────────────────
    codigo_natureza_despesa_completa = models.CharField(max_length=20, blank=True, null=True)
    subitem = models.CharField(max_length=20, blank=True, null=True)

    # ── Valores ───────────────────────────────────────────────────────
    valor_pago = models.CharField(max_length=50, blank=True, null=True)
    valor_restos_pagos = models.CharField(max_length=50, blank=True, null=True)
    valor_restos_pagos_cancelado = models.CharField(max_length=50, blank=True, null=True)
    valor_restos_pagos_inscritos = models.CharField(max_length=50, blank=True, null=True)
