...
from apps.portal_da_transparencia.models.despesas_execucao import DespesasExecucao
from apps.portal_da_transparencia.models.silver import DespesasExecucaoRecord


class Command(BaseImportCommand):
    help = "Importa N registros de Despesas - Execução (S3) para o banco Django"

    duckdb_model = DespesasExecucao
    django_model = DespesasExecucaoRecord
    default_ano  = "2022"
    default_mes  = "05"
