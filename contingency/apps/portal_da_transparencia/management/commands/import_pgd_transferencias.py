...
from apps.portal_da_transparencia.models.pgd_transferencias import PGDTransferencias
from apps.portal_da_transparencia.models.silver import PGDTransferenciasRecord


class Command(BaseImportCommand):
    help = "Importa N registros de PGD - Transferências (S3) para o banco Django"

    duckdb_model = PGDTransferencias
    django_model = PGDTransferenciasRecord
    default_ano  = "2022"
    default_mes  = "05"
