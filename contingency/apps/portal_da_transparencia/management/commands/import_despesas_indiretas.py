...
from apps.portal_da_transparencia.models.despesas_indiretas import DespesasIndiretas
from apps.portal_da_transparencia.models.silver import DespesasIndiretasRecord


class Command(BaseImportCommand):
    help = "Importa N registros de Despesas Indiretas (S3) para o banco Django"

    duckdb_model = DespesasIndiretas
    django_model = DespesasIndiretasRecord
    default_ano  = "2022"
    default_mes  = "05"
