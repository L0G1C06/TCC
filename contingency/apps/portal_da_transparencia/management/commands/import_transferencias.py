...
from apps.portal_da_transparencia.models.transferencias import Transferencias
from apps.portal_da_transparencia.models.silver import TransferenciasRecord


class Command(BaseImportCommand):
    help = "Importa N registros de Transferências (S3) para o banco Django"

    duckdb_model = Transferencias
    django_model = TransferenciasRecord
    default_ano  = "2022"
    default_mes  = "05"
