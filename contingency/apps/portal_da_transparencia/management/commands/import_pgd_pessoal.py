...
from apps.portal_da_transparencia.models.pgd_pessoal import PGDPessoal
from apps.portal_da_transparencia.models.silver import PGDPessoalRecord


class Command(BaseImportCommand):
    help = "Importa N registros de PGD - Pessoal (S3) para o banco Django"

    duckdb_model = PGDPessoal
    django_model = PGDPessoalRecord
    default_ano  = "2022"
    default_mes  = "05"
