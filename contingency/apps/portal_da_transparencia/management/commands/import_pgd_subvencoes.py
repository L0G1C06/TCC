...
from apps.portal_da_transparencia.models.pgd_subvencoes import PGDSubvencoes
from apps.portal_da_transparencia.models.silver import PGDSubvencoesRecord


class Command(BaseImportCommand):
    help = "Importa N registros de PGD - Subvenções (S3) para o banco Django"

    duckdb_model = PGDSubvencoes
    django_model = PGDSubvencoesRecord
    default_ano  = "2022"
    default_mes  = "05"
