...
from apps.portal_da_transparencia.models.pgd_servicos import PGDServicos
from apps.portal_da_transparencia.models.silver import PGDServicosRecord


class Command(BaseImportCommand):
    help = "Importa N registros de PGD - Serviços (S3) para o banco Django"

    duckdb_model = PGDServicos
    django_model = PGDServicosRecord
    default_ano  = "2022"
    default_mes  = "05"
